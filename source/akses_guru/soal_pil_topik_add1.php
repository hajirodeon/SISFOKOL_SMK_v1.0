...
//perintah SQL
$SQL2 = sprintf("INSERT INTO soal_pilihan(kd, kd_tapel, kd_semester, kd_keahlian, kd_tingkat, ".
					"kd_prog_pddkn, kd_guru, topik) ".
					"VALUES ('$x', '$tapelkd', '$smtkd', '$mprogkd', '$mkelkd', '$mpelkd', ".
					"'$mgkd', '$topik')");
...
$returner = "soal_pil.php?mgkd=$mgkd&mpelkd=$mpelkd&prog_pddkn=$prog_pdkn&mprogkd=$mprogkd".
