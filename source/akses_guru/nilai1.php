...
if ($totalRows_rs1 == 0) 
	{
	//masukkan baru
	$SQLi = sprintf("INSERT INTO siswa_nilai (kd, kd_tapel, kd_semester, kd_guru, kd_prog_pddkn, ".
	...
	//auto-kembali
	$returner = "nilai.php?mgkd=$mgkd&mpelkd=$mpelkd&prog_pddknn=$prog_pddkn&mprogkd=$mprogkd&keahlian=$keahlian&".
					"mkelkd=$mkelkd&tingkat=$tingkat&mrkd=$mrkd&ruang=$ruang&mnkd=$mnkd&kat=$kat";
	...
	//auto-kembali
	$returner = "nilai.php?mgkd=$mgkd&mpelkd=$mpelkd&prog_pddkn=$prog_pddkn&mprogkd=$mprogkd&keahlian=$keahlian&".
					"mkelkd=$mkelkd&tingkat=$tingkat&mrkd=$mrkd&ruang=$ruang&mnkd=$mnkd&kat=$kat";
	header("location:$returner");
	}
?>