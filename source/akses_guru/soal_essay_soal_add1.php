...
$SQL1 = sprintf("SELECT soal_essay.*, soal_essay_detail.* ".
					...
					"AND soal_essay.kd_keahlian = '$mprogkd' ".
					"AND soal_essay.kd_tingkat = '$mkelkd' ".
					"AND soal_essay.kd_prog_pddkn = '$mpelkd' ".
...
if ($totalRows_rs1 != 0) 
	...
	$returner = "soal_essay_soal.php?mgkd=$mgkd&mpelkd=$mpelkd&prog_pddkn=$prog_pddkn".
				"&mprogkd=$mprogkd&keahlian=$keahlian&mkelkd=$mkelkd&tingkat=$tingkat&topikkd=$topikkd".
				"&topik=$topik";
