...
if ($totalRows_rscek != 0) 
	...
	{
	$SQL = sprintf("INSERT INTO siswa_raport_ekstra(kd, kd_siswa, kd_tapel, kd_semester, kd_keahlian, ".
					"kd_tingkat, kd_ruang, kd_ekstra, kd_nilai) ".
					"VALUES ('$x', '$kd', '$row_rstapel[kd]', '$row_rssmt[kd]', ".
					"'$mpkd', '$mkkd', '$mrkd', '$ekstrakd', '$angkakd')");
