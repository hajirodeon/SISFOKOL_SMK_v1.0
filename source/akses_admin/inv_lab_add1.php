...
//cek, sudah ada belum
$SQL1 = sprintf("SELECT * FROM inv_lab WHERE lab = '$lab'");
...
if ($totalRows_rs1 != 0) 
	{
	$pesan = "Ruang Praktikum / Lab sudah ada. Ganti dengan yang lainnya!";
	$kembali = "inv_lab_add.php";
...
//perintah SQL
$SQL2 = sprintf("INSERT INTO inv_lab(kd, lab) ".
					"VALUES ('$x', '$lab')");
