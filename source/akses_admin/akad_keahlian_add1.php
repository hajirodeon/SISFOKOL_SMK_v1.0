...
//cek, sudah ada belum
$SQL1 = sprintf("SELECT * FROM m_keahlian ".
...
if ($totalRows_rs1 != 0) 
	{
	$pesan = "Keahlian sudah ada, Silahkan diulangi!";
	$kembali = "akad_keahlian_add.php";
	...
	{
//perintah SQL
$SQL2 = sprintf("INSERT INTO m_keahlian(kd, keahlian) ".
					"VALUES ('$x', '$keahlian')");
