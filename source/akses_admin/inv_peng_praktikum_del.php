...
$labkod = cegah($_REQUEST['labkod']);
$lab = cegah($_REQUEST['lab']);

//dilarang macam - macam
if (!ctype_alnum($kdi))
	{
	$pesan = "ERROR";
	$kembali = "../logout.php";
...
//perintah SQL
$SQL = sprintf("DELETE FROM inv_peng_lab WHERE kd = '$kdi'");
...
header("location:inv_peng_praktikum.php?labkod=$labkod&lab=$lab");
}
