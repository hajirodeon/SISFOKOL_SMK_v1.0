...
if ($totalRows_rs1 != 0) 
	...
	echo "<script>alert('$pesan');location.href='$pesan'</script>";
	}
...
$SQL2 = sprintf("INSERT INTO m_siswa(kd, nis, password, passortu, nama, kd_kelamin, kd_agama, ".
					"tmp_lahir, tgl_lahir, anak_ke, status_kel, alamat, telepon, diterima_keahlian, ".
					"diterima_tingkat, diterima_tgl, kd_tapel, asl_sek, almt_sek, nm_ayah, nm_ibu, ".
					"pek_ayah, pek_ibu) VALUES ('$x', '$nis', '$password', '$password', '$nama', ".
					"'$jekel', '$agm', '$tmplahir', '$tgl1', '$anakke', '$status_kel', '$alamat', ".
					"'$telp', '$keahlian', '$tingkat', '$tgl2', '$tapel', '$asl_sek', '$almt_sek', ".
...
//masukan ke data siswa keahlian
$SQL3 = sprintf("INSERT INTO siswa_keahlian(kd_keahlian, kd_siswa) ".
					"VALUES ('$keahlian', '$x')");
...
//masukan ke data siswa tingkat
$SQL4 = sprintf("INSERT INTO siswa_tingkat(kd_tapel, kd_tingkat, kd_siswa, status) ".
					"VALUES ('$tapel', '$tingkat', '$x', 'true')");
