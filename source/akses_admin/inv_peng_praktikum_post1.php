...
//jika iya, update saja
	if ($totalRows_rscek != 0) 
		{
		$SQL = sprintf("UPDATE inv_peng_lab SET kd_keahlian = '$keahlian', ".
						"kd_tingkat = '$tingkat', ".
						"kd_ruang = '$ruang' ".
						"WHERE kd_lab = '$labkod' ".
						"AND kd_hari = '$kd_hari' ".
		...
		$SQL = sprintf("INSERT INTO inv_peng_lab(kd, kd_lab, kd_hari, kd_jam, kd_keahlian, kd_tingkat, ".
							"kd_ruang) VALUES ('$x', '$labkod', '$kd_hari', '$kd_jam', '$keahlian', ".
							"'$tingkat', '$ruang')");
