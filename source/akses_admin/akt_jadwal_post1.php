...
$keahkod = cegah($_POST['keahkod']);
$tingkod = cegah($_POST['tingkod']);
...
if ($totalRows_rsngajar != 0) 
	...
	$SQLiya = sprintf("SELECT jadwal.*, m_keahlian.*, m_tingkat.*, m_ruang.* ".
						"FROM jadwal, m_keahlian, m_tingkat, m_ruang ".
						"WHERE jadwal.kd_keahlian = m_keahlian.kd ".
						"AND jadwal.kd_tingkat = m_tingkat.kd ".
	...
	$pesan = "Guru telah mengajar di Keahlian : $row_rsiya[keahlian], Tingkat : $row_rsiya[tingkat], ".
				"Ruang : $row_rsiya[ruang] . Silahkan Diganti!";
	$returner = "akt_jadwal.php?tapelkod=$tapelkod&smtkod=$smtkod&keahkod=$keahkod&tingkod=$tingkod".
	...
	if ($totalRows_rscek != 0) 
		...
		{
		$SQL = sprintf("INSERT INTO jadwal(kd, kd_tapel, kd_semester, kd_keahlian, kd_tingkat, kd_ruang, ".
						"kd_hari, kd_jam_pel, kd_guru) VALUES ('$x', '$tapelkod', '$smtkod', ".
						"'$keahkod', '$tingkod', '$rukod', '$harikod', ".
						"'$jamkod', '$guru')");
...
//auto-kembali
$returner = "akt_jadwal.php?tapelkod=$tapelkod&smtkod=$smtkod&keahkod=$keahkod".
				"&tingkod=$tingkod&rukod=$rukod&harikod=$harikod&jamkod=$jamkod";
